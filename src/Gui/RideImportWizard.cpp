    ...
    for (int i=0; i< filenames.count(); i++) {
        ...
        if (ride) {
            ...
            if(workoutNameToRoute->currentIndex() == 1){ // Adds Workout name as Route
                ...
                ride->setTag("Calendar Text", workoutNameList.first());
                ride->setTag("Sport", "VirtualRide");
            }
            if(workoutNameToRoute->currentIndex() == 2){ // Adds filename of imported file(s) as Rout
                ...
                ride->setTag("Calendar Text", importFileNameList.first());
                ride->setTag("Sport", "VirtualRide");
            }
